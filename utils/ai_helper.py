...
def _translate_text_dict(text: str) -> str:
    """ترجمة قاموسية ذكية للعبارات والكلمات العربية الشائعة إلى الإنجليزية."""
    if not text:
        return ""
    ...
    translations = [
        ...
        ("برمجة الأتمتة", "Process Automation Programming"),
        ...
        ("إتقان ممتاز", "Fluent / Native"),
        ("متوسط بالإنجليزية", "English (Intermediate)"),
        ("متوسط بالانجليزية", "English (Intermediate)"),
        ("متوسط", "Intermediate"),
    ...
    for ar_term, en_term in translations:
        res = re.sub(re.escape(ar_term), en_term, res, flags=re.IGNORECASE)
    return res
...
Translate EVERY single word and phrase from Arabic into fluent professional English. Do NOT leave any Arabic script inside the English CV. If candidate names or institutions are in Arabic, transliterate them accurately into English.

Strict Format:
1. Write a compelling Professional Summary (3-4 lines) in English highlighting the candidate's core technical skills and expertise.
2. Structure and format Skills, Work Experience, Education, and Languages in clear English bullet points.
3. Output standard section titles in this exact order:
Contact Information
